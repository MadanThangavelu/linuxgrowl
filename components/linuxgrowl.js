...
const CONTRACT_ID = "@growlforlinux.com/linuxgrowl;1";
...
Growl.prototype = {
    ...
    init : function(){
        try{
            ...
            observerService.addObserver(this, "linuxgrowlclickcallback", false);
    ...
    runCommand: function(command, args){
	    	...
	    	try {
	    	    ...
	    	    sample.alert(null, "Process initWithPath", "nofigy-send is expected at location /use/bin/notify-send. Add appropriate symlinks.");
	    	    return 1;
		}
		...
		try {
		    ...
		    sample.alert(null, "Process init", e);
		    return 1;
		}
            ...
            try{
                ...
                if(str.indexOf("GNTP/1.0 -OK") == 0){
                    ...
                    Components.classes["@mozilla.org/observer-service;1"]
                        ...
                        .notifyObservers(null, "linuxgrowlclickcallback", "{\"context\":\"" + context + "\",\"type\":\"" + type + "\"}");
                }
                else{
                }
            }
...
growl = Components.classes["@growlforlinux.com/linuxgrowl;1"].
